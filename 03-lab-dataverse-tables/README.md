...
1. While viewing the Table, notice the data rows at the bottom.
2. Click on the **Edit** button (or 'edit in new tab' to switch to the table's data view)
3. Add **3-4 sample rows** with fictional data:
